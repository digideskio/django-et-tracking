...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SendReport.block_bounced'
        db.add_column('et_sendreport', 'block_bounced',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ReceiverReport.block_bounced'
        db.add_column('et_receiverreport', 'block_bounced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SendReport.block_bounced'
        db.delete_column('et_sendreport', 'block_bounced')

        # Deleting field 'ReceiverReport.block_bounced'
        db.delete_column('et_receiverreport', 'block_bounced')
