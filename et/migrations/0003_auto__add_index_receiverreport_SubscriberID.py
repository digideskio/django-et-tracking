...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ReceiverReport', fields ['SubscriberID']
        db.create_index('et_receiverreport', ['SubscriberID'])


    def backwards(self, orm):
        # Removing index on 'ReceiverReport', fields ['SubscriberID']
        db.delete_index('et_receiverreport', ['SubscriberID'])
