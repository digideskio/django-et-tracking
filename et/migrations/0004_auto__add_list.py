...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'List'
        db.create_table('et_list', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ClientID', self.gf('django.db.models.fields.IntegerField')()),
            ('ListID', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('Name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('Description', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('DateCreated', self.gf('django.db.models.fields.DateTimeField')()),
            ('Status', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('ListType', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('et', ['List'])


    def backwards(self, orm):
        # Deleting model 'List'
        db.delete_table('et_list')
